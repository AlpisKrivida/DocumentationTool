...
namespace DocumentationTool.Server.Migrations
{
    ...
    [Migration("20200522213424_newupdate10")]
    partial class newupdate10
    {
            ...
            modelBuilder.Entity("DocumentationTool.Shared.Entities.Infrastructure.Cable", b =>
                {
                    ...
                    b.HasOne("DocumentationTool.Shared.Entities.Hardware.RouterDevice", "Router")
                        .WithOne("Cable")
                        .HasForeignKey("DocumentationTool.Shared.Entities.Infrastructure.Cable", "RouterID");

                    b.HasOne("DocumentationTool.Shared.Entities.Hardware.ServerDevice", "Server")
                        .WithOne("Cable")
                        .HasForeignKey("DocumentationTool.Shared.Entities.Infrastructure.Cable", "ServerID");

                    b.HasOne("DocumentationTool.Shared.Entities.Hardware.Switch", "Switch")
                        .WithOne("Cable")
                        .HasForeignKey("DocumentationTool.Shared.Entities.Infrastructure.Cable", "SwitchID");
                });
