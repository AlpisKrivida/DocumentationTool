...
#nullable disable
    ...
    public partial class PortCreate : Microsoft.AspNetCore.Components.ComponentBase
    {
        ...
        {
            __builder.OpenElement(0, "ServerForm");
            __builder.AddAttribute(1, "Server", "Server");
            __builder.AddAttribute(2, "Model", "Model");
            __builder.AddAttribute(3, "General", "General");
            __builder.AddAttribute(4, "FormFactor", "FormFactor");
            __builder.AddAttribute(5, "PowerConsumer", "PowerConsumer");
            __builder.AddAttribute(6, "CPU", "CPU");
            __builder.AddAttribute(7, "Memory", "Memory");
            __builder.AddAttribute(8, "OnValidSubmit", "SaveServer");
